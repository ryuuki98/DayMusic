...
const BoardDetail = () => {
    ...
    const handleSubmit = (e) => {   // 좋아요 추가제거 이벤트
        e.preventDefault();
        ...
        >
            ...
            {loading ? (
                ...
                <>
                    ...
                    >
                        <Button flex='1' variant='ghost' leftIcon={<BiLike />} onClick={handleSubmit} value={post.board_code}>
                        <Text>{likeCount}</Text>
                        <Box as="span" mx="2"></Box>
                        Like
                        </Button>
                        <Button flex='1' variant='ghost' leftIcon={<BiLike />} onClick={listSubmit} value={post.board_code}>
                        Likelist
                        </Button>
