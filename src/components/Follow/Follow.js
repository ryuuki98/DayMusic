...
import MyMusicBoardList from '../Board/MyMusicBoardList';
        ...
        <Box maxW="700px" mx="auto" mt="5">
            <Flex align="center" mb="4">
                ...
                <VStack ml="200px">
                    ...
                    <Button colorScheme="gray" variant="ghost" width="50%">
                        게시물
                    </Button>
                </VStack>
                <VStack>
                    <Text fontSize="20px">{followerCount}</Text>
                    <Button colorScheme="gray" variant="ghost" width="50%" onClick={onFollowerListOpen}>
                        팔로워
                    </Button>
                </VStack>
                <VStack>
                    <Text fontSize="20px">{followedCount}</Text>
                    <Button colorScheme="gray" variant="ghost" width="50%" onClick={onFollowListOpen}>
                        팔로잉
                    </Button>
                </VStack>
            </Flex>
            ...
            {showMyMusicBoardPosts && <MyMusicBoardList onPostCountChange={setMusicPostCount} fetchMusicPostCount={fetchMusicPostCount} />}

            <Flex justify="space-between" mt="4" px="4" py="2" borderTopWidth="1px"></Flex>
            ...
            <Modal isOpen={isFollowListOpen} onClose={onFollowListClose}>
                ...
                <ModalContent>
                    ...
                    <ModalFooter>
                        <Button variant="ghost" onClick={onFollowListClose}>
                            닫기
                        </Button>
                    </ModalFooter>
                </ModalContent>
            ...
            <Modal isOpen={isFollowerListOpen} onClose={onFollowerListClose}>
                ...
                <ModalContent>
                    ...
                    <ModalFooter>
                        <Button variant="ghost" onClick={onFollowerListClose}>
                            닫기
                        </Button>
                    </ModalFooter>
                </ModalContent>
